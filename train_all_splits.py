...
closeup_i3d_config_prefix = "/data/home/bedward/workspace/mmpose-project/mmaction2/configs/recognition/i3d/i3d_r50_32x2x1_100e_kinetics400_rgb_apas_frontal_split"
...
for split in range(1, 6):
    out = subprocess.check_output(f"python tools/train.py {config_prefix}{split}.py &> logs/{os.path.basename(config_prefix)}.log.txt", shell=True)
    print(out)