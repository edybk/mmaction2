...
ann_file_train = 'data/apas_pose/train.split1.pkl'
ann_file_val = 'data/apas_pose/val.split1.pkl'
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_u48_240e_apas_xsub_keypoint'
load_from = None
resume_from = None
