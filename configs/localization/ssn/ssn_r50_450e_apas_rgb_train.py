...
data_root = './data/apas_activitynet/rawframes/'
data_root_val = './data/apas_activitynet/rawframes/'
ann_file_train = 'data/apas_activitynet/activitynet/thumos14_tag_val_proposal_list.txt'
ann_file_val = 'data/apas_activitynet/activitynet/thumos14_tag_val_proposal_list.txt'
ann_file_test = 'data/apas_activitynet/activitynet/thumos14_tag_test_proposal_list.txt'
